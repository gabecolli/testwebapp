""" 
In this sample, the Flask app object is contained within the note_app *module*;
that is, note_app contains an __init__.py along with relative imports. Because
...
from sparkon_app.webapp import app